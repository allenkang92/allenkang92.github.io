...
{% assign series_key = "Mathematics-Philosophy-History" %}
...
<section class="series-hub" aria-labelledby="series-hub-title">
  ...
  <h1 id="series-hub-title">수학철학·수학사</h1>
  <p>
    수학이 어떻게 생겨났고, 어떤 논리와 존재론을 통해 정당화되며, 왜 현실 세계에 잘 적용되는지
    차례로 읽는 경로입니다.
  </p>
...
<section class="series-reference-note" aria-labelledby="series-reference-title">
  ...
  <ul>
    <li>Morris Kline, <cite>Mathematical Thought from Ancient to Modern Times</cite></li>
    <li>Stewart Shapiro, <cite>Thinking about Mathematics</cite></li>
    <li>Imre Lakatos, <cite>Proofs and Refutations</cite></li>
    <li>Eugene Wigner, <cite>The Unreasonable Effectiveness of Mathematics in the Natural Sciences</cite></li>
  </ul>
</section>
