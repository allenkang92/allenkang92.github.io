...
description: CSS 문법, 선택자, 우선순위, 박스 모델, 단위, 배경, 타이포그래피 기초를 정리합니다.
...
series_order: 2
learning_outcomes:
  - "CSS 선택자와 선언, 적용 방식의 차이를 이해합니다."
  - "구체성, 상속, 선언 순서가 스타일 결과를 바꾸는 방식을 정리합니다."
  - "박스 모델, 단위, 배경, 폰트 같은 레이아웃 기초를 복습합니다."
references:
  - title: "MDN Web Docs, CSS: Cascading Style Sheets"
