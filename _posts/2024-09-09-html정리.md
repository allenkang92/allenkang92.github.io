---
layout: post
title: "HTML 및 CSS 기초와 시맨틱 마크업_01"
description: HTML의 기본 문서 구조, 태그, 속성, 시맨틱 마크업과 폼 요소를 입문 관점에서 정리합니다.
...
series_order: 1
learning_outcomes:
  - "HTML 문서의 기본 구조와 태그, 속성, 중첩 규칙을 정리합니다."
  - "텍스트, 링크, 이미지, 표, 폼 요소의 역할을 구분합니다."
  - "시맨틱 마크업이 접근성과 유지보수에 왜 중요한지 이해합니다."
references:
...
- `<a href = "https://example.com">`: 링크 생성
...
- `<img src = "image.jpg" alt = "대체텍스트">`: 이미지 삽입
