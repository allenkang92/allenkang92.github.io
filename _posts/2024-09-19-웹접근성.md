...
**웹 접근성(Web Accessibility)**은 장애를 가진 사람을 포함하여 모든 사용자가 웹 콘텐츠에 접근하고 이용할 수 있도록 보장하는 것을 의미.
...
**WCAG(Web Content Accessibility Guidelines)**은 W3C의 WAI(Web Accessibility Initiative)에서 제공하는 웹 접근성 지침.
